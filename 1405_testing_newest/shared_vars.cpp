...
/*Exam Firebase Data*/
volatile uint16_t Speed = 150; //only one speed, from lab5; applicable to LineTracking, MotorControl funcions
volatile float LeftSpeed = 45.0f;   // 0.0f - 1024.0f
volatile float RightSpeed = 45.0f;  // 0.0f - 1024.0f
