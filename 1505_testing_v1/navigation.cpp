...
/*function for task1:, route: 9-2-1*/
    void handleTask1() {
        ...
        if(!endTask1){
            LineTracking::FollowingLine(IR::Task1(), LeftSpeed,RightSpeed);
...
/*function for task2, route: 9-2-1 with pesudo traffic light1-1*/
    void handleTask2() {
        ...
        if(!endTask2){
            LineTracking::FollowingLine(IR::Task2(), LeftSpeed,RightSpeed);
        ...
        switch (sub_case) {
            case task3_node6: // ending at node6 (left parking lot)
                if(!endTask3){
                    ...
                    LineTracking::FollowingLine(IR::Task3(), LeftSpeed,RightSpeed);
                    String currentTag = getTagUID();
...
/*function for task4*/
    void handleTask4(uint8_t sub_case) {
        switch (sub_case) {
            ...
            case task4_node1: // starting from node1 
                if(!endTask4){
                    LineTracking::FollowingLine(IR::Task4(),LeftSpeed,RightSpeed);
                    String currentTag = getTagUID();
    ...
    NodeCondition ALL_NODE_CONDITIONS[TOTAL_NODES_CONDITIONS] = {
        {false, "node1_1", 5,1,3,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 5-1-3 left
        {false, "node1_2", 5,1,2,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 5-1-2 straight
        {false, "node1_3", 3,1,5,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 3-1-5 right
        {false, "node1_4", 3,1,2,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 3-1-2 left
        {false, "node1_5", 2,1,5,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 2-1-5 straight
        {false, "node1_6", 2,1,3,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 2-1-3 right

        {false, "node2_1", 1,2,3,[]() {LineTracking::FollowingLine(10, LeftSpeed,RightSpeed);}}, // 1-2-3 L_135
        {false, "node2_2", 1,3,9,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 1-2-9 straight
        {false, "node2_3", 3,2,1,[]() {LineTracking::FollowingLine(9, LeftSpeed,RightSpeed);}}, // 3-2-1 R_135
        {false, "node2_4", 3,2,9,[]() {LineTracking::FollowingLine(3, LeftSpeed,RightSpeed);}}, // 3-2-9 L_45
        {false, "node2_5", 9,2,1,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 9-2-1 straight
        {false, "node2_6", 9,2,3,[]() {LineTracking::FollowingLine(2, LeftSpeed,RightSpeed);}}, // 9-2-3 R_45

        {false, "node3_1", 1,3,4,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 1-3-4 L_90
        {false, "node3_2", 1,3,2,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 1-3-2 R_90
        {false, "node3_3", 4,3,1,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 4-3-1 R_90
        {false, "node3_4", 4,3,2,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 4-3-2 straight
        {false, "node3_5", 2,3,1,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 2-3-1 L_90
        {false, "node3_6", 2,3,4,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 2-3-4 straight

        {false, "node4_1", 5,4,7,[]() {LineTracking::FollowingLine(3, LeftSpeed,RightSpeed);}}, // 5-4-7 L_45
        {false, "node4_2", 5,4,3,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 5-4-3 straight
        {false, "node4_3", 7,4,5,[]() {LineTracking::FollowingLine(2, LeftSpeed,RightSpeed);}}, // 7-4-5 R_45
        {false, "node4_4", 7,4,3,[]() {LineTracking::FollowingLine(9, LeftSpeed,RightSpeed);}}, // 7-4-3 L_135
        {false, "node4_5", 3,4,5,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 3-4-5 straight
        {false, "node4_6", 3,4,7,[]() {LineTracking::FollowingLine(9, LeftSpeed,RightSpeed);}}, // 3-4-7 R_135

        {false, "node5_1", 1,5,10,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 1-5-10 straight
        {false, "node5_2", 1,5,4,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 1-5-4 R_90
        {false, "node5_3", 10,5,1,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 10-5-1 straight
        {false, "node5_4", 10,5,4,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 10-5-4 L_90
        {false, "node5_5", 4,5,1,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 4-5-1 L_90
        {false, "node5_6", 4,5,10,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 4-5-10 R_90

        {false, "node7_1", 4,7,8,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 4-7-8 L_90
        {false, "node7_2", 4,7,11,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 4-7-11 straight
        {false, "node7_3", 4,7,6,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 4-7-6 R_90
        {false, "node7_4", 11,7,4,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 11-7-4 straight
        {false, "node7_5", 11,7,8,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 11-7-8 R_90
        {false, "node7_6", 11,7,6,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 11-7-6 L_90

        {false, "node9_1", 2,9,10,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 2-9-10 L_90
        {false, "node9_2", 2,9,11,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 2-9-11 straight
        {false, "node9_3", 10,9,2,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 10-9-2 R_90
        {false, "node9_4", 10,9,11,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 10-9-11 L_90
        {false, "node9_5", 11,9,2,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 11-9-2 straight
        {false, "node9_6", 11,9,10,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 11-9-10 R_90

        {false, "node10_1", 5,10,11,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 5-10-11 straight
        {false, "node10_2", 5,10,9,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 5-10-9 R_90
        {false, "node10_3", 11,10,5,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 11-10-5 straight
        {false, "node10_4", 11,10,9,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 11-10-9 L_90
        {false, "node10_5", 9,10,5,[]() {LineTracking::FollowingLine(8,LeftSpeed,RightSpeed);}}, // 9-10-5 L_90
        {false, "node10_6", 9,10,11,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 9-10-11 R_90

        {false, "node11_1", 7,11,10,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 7-11-10 L_90
        {false, "node11_2", 7,11,9,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 7-11-9 R_90
        {false, "node11_3", 10,11,7,[]() {LineTracking::FollowingLine(7, LeftSpeed,RightSpeed);}}, // 10-11-7 R_90
        {false, "node11_4", 10,11,9,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 10-11-9 straight
        {false, "node11_5", 9,11,7,[]() {LineTracking::FollowingLine(8, LeftSpeed,RightSpeed);}}, // 9-11-7 L_90
        {false, "node11_6", 9,11,10,[]() {LineTracking::FollowingLine(1, LeftSpeed,RightSpeed);}}, // 9-11-10 straight
  };
            ...
            for(uint8_t i=0; i<TOTAL_NODES_CONDITIONS; ++i){
                if(ALL_NODE_CONDITIONS[i].lastNode == prevNode 
                    ...
                    if(isInRegion(getTagUID())==centerNode){
                        ...
                        Serial.println(ALL_NODE_CONDITIONS[i].name);
                        if( currentTag=="aa7b8dbc"||currentTag=="cac38bbc"||currentTag=="0a988dbc"||currentTag=="8a978dbc"||currentTag=="0a978dbc"||currentTag=="4ac88dbc"||currentTag=="7d4a89f4"||currentTag=="8d4a89f4"){
                            LineTracking::FollowingLine(OnTrack,LeftSpeed+200,RightSpeed+200);
                        }
